...
import { GetOrSetNonceResult, MetadataParams, RetrieveSharesResponse, SetCustomKeyOptions, TorusCtorOptions, TorusPublicKey, VerifierParams } from "./interfaces";
declare class Torus {
    metadataHost: string;
    allowHost: string;
    ...
    getUserTypeAndAddress(endpoints: string[], torusNodePubs: INodePub[], { verifier, verifierId }: {
        verifier: string;
        verifierId: string;
    }, doesKeyAssign?: boolean): Promise<TorusPublicKey>;
